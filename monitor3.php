...
mysql_query("update street_det set abnormal=1 where id=$g && not_work=0");
mysql_query("update street_det set not_work=1 where id=$h && abnormal=0");
...
<div align="center">
    ...
    <table width="100%" border="1">
      <tr>
        ...
        <th width="120" class="bg1" scope="col">City</th>
        <th width="112" class="bg1" scope="col">Area</th>
        <th width="135" class="bg1" scope="col">Street</th>
        <th width="107" class="bg1" scope="col">Light</th>
        <th width="228" class="bg1" scope="col">Power Level </th>
        <th width="282" class="bg1" scope="col">Staus</th>
      </tr>
      <?php
	  $i=0;
      ...
      <tr <?php if($row['not_work']=="1") { echo $nw; } else if($row['abnormal']=="1") { echo $ab; } else { echo "class=bg2"; } ?>>
        ...
        <td style="background-color:<?php echo $cla; ?>"><?php
		echo $lep;
		?></td>
        <td><?php
...
//   //Redirect with JavaScript
   window.location.href= 'monitor3.php';
}, 10000);
</script>
<?php
//}
